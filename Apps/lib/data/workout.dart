...
class Workout {
  ...
  @override
  String toString() {
    return '{ ${this.workoutId}, ${this.workoutCoach}, ${this.workoutDurationTime}, ${this.workoutIcon}, ${this.workoutIsOnline}, ${this.workoutLocation}, ${this.workoutName}, ${this.workoutTime}, ${this.workoutColor} }';
  }
